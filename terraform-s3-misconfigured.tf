...
# Bucket policy explicitly denies public write access to all principals
...
output "security_warnings" {
  value = "NOTE: Public write access has been blocked on this bucket. Block Public Access is enabled and the bucket ACL is set to private."
}

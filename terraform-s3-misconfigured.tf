...
# ACL restricted to bucket owner only (no public write access)
...
# Bucket policy removed; all public access is blocked by aws_s3_bucket_public_access_block above.

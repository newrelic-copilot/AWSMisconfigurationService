...
# Remediated: Block public write access (previously all settings were false)
...
# Remediated: Changed from public-read-write to private
...
# Remediated: Removed public write access; policy now denies write actions to non-IAM principals
...
output "security_warnings" {
  value = "INFO: Public write access has been blocked for this bucket. Encryption and versioning are still not configured."
}
